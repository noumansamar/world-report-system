# -------- Stage 1: Build the self-contained JAR with Maven --------
FROM maven:3.9-eclipse-temurin-17 AS build

WORKDIR /app

# Copy pom.xml first (better Docker layer caching for dependencies)
COPY pom.xml .
...
# Build the project into a self-contained JAR
# (skip tests here — tests should run separately in GitHub Actions)
